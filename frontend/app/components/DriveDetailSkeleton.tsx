  ...
  return (
    <div className="min-h-screen flex flex-col bg-linear-to-tr from-[#012326] to-[#013e4a] font-sans dark:bg-black">
      <main className="flex-1 pt-24 mx-6 sm:mx-8 md:mx-12 lg:mx-12">
        ...
        <div className="relative w-full h-[250px] sm:h-[300px] md:h-[350px] lg:h-[400px] mb-8 sm:mb-10 md:mb-12 bg-gray-200 rounded-lg animate-pulse" />
            ...
            <div className="sticky top-24 flex flex-col gap-4 sm:gap-6 z-10">
              ...
              <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8">
                <div className="flex flex-col items-center justify-center gap-4">
                  ...
                  {/* Button Skeleton */}
                  <div className="w-full md:w-auto h-12 bg-gray-200 rounded-lg animate-pulse" />
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div
                    key={i}
                    className="relative aspect-square rounded-lg bg-gray-200 animate-pulse"
                  />
                ))}
              </div>
            </div>
